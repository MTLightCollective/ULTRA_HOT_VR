AFRAME.registerComponent('grab', {
    ...
    play: function () {
      ...
      el.addEventListener('pinchended', this.onGripOpen);
      el.addEventListener('pinchstarted', this.onGripClose);
    },
    ...
    pause: function () {
      ...
      el.removeEventListener('triggerup', this.onGripOpen);
        ...
        el.removeEventListener('pinchended', this.onGripOpen);
        el.removeEventListener('pinchstarted', this.onGripClose);
    },
